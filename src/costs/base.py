...
class BaseCost(ABC):
    ...
    def __call__(self, simulation_data: SimulationData, simulation, return_B1 = False, return_SAR = False) -> float:
        return self.calculate_cost(simulation_data, simulation, return_B1, return_SAR)
